<template>
	<div>
		...
		<el-form :model="tosendFrom" ref="tosendFrom" :rules="rules">
			<!-- 出发地 -->
			<position :forfrom="tosendFrom" prop="buyaddress" text="发货地址">
				<img src="../assets/imgs/map1.png" slot="icon">
				<img src="../assets/imgs/map1.png" slot="icon1">
				<img src="../assets/imgs/map1.png" slot="icon2">
			</position>
			<!-- 目的地 -->
			<position :forfrom="tosendFrom" prop="sendaddress" text="收获地址">
			...
			<listone>
				...
				<el-form-item slot="data">
					<el-checkbox-group v-model="tosendFrom.type">
	 			...
	 			<el-row type="flex" justify="space-around">
	 				...
	 				<el-col :span="12">
	 					<el-form-item prop="thingtip" class="textareabox">
						    <el-input  type="textarea" resize="none" :rows="2" v-model="tosendFrom.thingtip"   placeholder=" 填写商品信息" :maxlength="36"></el-input>
			...
			<listone>
				...
				<el-form-item slot="data">
					<el-form-item prop="phoneNumber" ref="phoneNumber">
				  		<el-input type="number" v-model.number="tosendFrom.phoneNumber" size="small"></el-input>
				  </el-form-item>
				</el-form-item>
			</listone>
				<!-- price -->
			<listone>
				...
				<el-form-item slot="data">
					<el-form-item prop="price" ref="price">
				  		<el-input type="number" v-model.number="tosendFrom.price" size="small"></el-input>
				  </el-form-item>
				</el-form-item>
			</listone>
...
computed: {
	lengthTip () {
		return this.tosendFrom.thingtip.length+'/36';
	}
},
components:{
	RunHeader,
...
methods:{
	submitFun(){
		this.$refs.tosendFrom.validate((valid) => {
			if (valid) {
			alert('submit!');
			} else {
